		  ...
		  <div class="card-body">
			...
			<form class="forms-sample" method="post" action="{{ url('agent/transactions/add') }}">
			  ...
			  <div class="row mb-3">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" name="order_number" placeholder="Enter Order Number" required>
				</div>
			  </div>
			  ...
			  <div class="row mb-3">
				...
				<div class="col-sm-9">
				  <input type="number" name="amount" class="form-control" placeholder="Enter Amont" required>
				</div>
			  </div>          
