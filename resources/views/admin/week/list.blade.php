			...
			<div class="card-body">
			  <div class="d-flex justify-content-between align-items-center flex-wrap">
				...
				<div class="d-flex align-items-center">
				  <a href="{{ url('admin/week/add') }}" class="btn btn-primary">Add Week</a>
				</div>
			  </div>
