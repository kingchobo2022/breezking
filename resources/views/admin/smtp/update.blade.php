        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="post" action="{{ url('admin/smtp_update') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="app_name" value="" class="form-control" autocomplete="off" placeholder="Enter App Name" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="mail_mailer" value="" class="form-control" autocomplete="off" placeholder="Enter Mail mailer" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="mail_host" value="" class="form-control" autocomplete="off" placeholder="Enter Mail host" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="mail_port" value="" class="form-control" autocomplete="off" placeholder="Enter Mail port" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="mail_username" value="" class="form-control" autocomplete="off" placeholder="Enter Mail Username" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="mail_password" value="" class="form-control" autocomplete="off" placeholder="Enter Mail Password" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="mail_encryption" value="" class="form-control" autocomplete="off" placeholder="Enter Mail Encryption" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" name="mail_from_address" value="" class="form-control" autocomplete="off" placeholder="Enter Mail From Address" required>
